...
export default function AddProductScreen() {
  ...
  useEffect(() => {
    ...
    setTaxApplicable(draft.taxApplicable);
    setReturnable(draft.returnable);
  ...
  const handleSaveAsDraft = async () => {
    ...
    try {
      ...
      console.log('[v0] Product saved as draft:', {
        productName,
        category,
        brand,
        unitSize,
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="bg-white px-4 py-4 border-t border-gray-200 safe-area-bottom">
        ...
        <TouchableOpacity
          ...
          disabled={isLoading}
          activeOpacity={0.7}
          className={`w-full bg-gray-100 border border-gray-300 rounded-xl py-4 items-center justify-center ${isLoading ? 'opacity-50' : ''}`}
        >
          {isLoading ? (
