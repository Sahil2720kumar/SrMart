...
export default function TabLayout() {
  ...
  return (
    <Tabs >
      ...
      >
        <TabTrigger name="home" href="/delivery/home" asChild>
          <Pressable className="flex-1">
            <TabButton label="Home" focused={pathname === '/delivery/home'}>
              <HomeIcon focused={pathname === "/delivery/home"} />
            </TabButton>
          </Pressable>
        </TabTrigger>
        ...
        <TabTrigger name="earning" href="/delivery/earning" asChild>
          <Pressable className="flex-1">
            <TabButton label="Earning" focused={pathname.startsWith("/delivery/earning")}>
            <FontAwesome name="rupee" size={24} color={pathname.startsWith("/delivery/earning") ? "#16a34a" : "#9ca3af"} />
            </TabButton>
          </Pressable>
        </TabTrigger>

        <TabTrigger name="orders" href="/delivery/orders" asChild>
          <Pressable className="flex-1">
            <TabButton label="Orders" focused={pathname.startsWith("/delivery/orders")}>
              <OrdersIcon focused={pathname.startsWith("/delivery/orders")} />
            </TabButton>
          </Pressable>
        </TabTrigger>
